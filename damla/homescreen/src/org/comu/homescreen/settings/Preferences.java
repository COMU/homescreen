...
import org.comu.homescreen.IconCache;
import org.comu.homescreen.IconItemInfo;
import org.comu.homescreen.Launcher;
import android.R;
import org.comu.homescreen.ShortcutInfo;
...
public class Preferences implements OnSharedPreferenceChangeListener {
	...
	public void setLauncher(Launcher launcher) {
		if (launcher == null && mPreferences != null) {
			...
			PreferenceManager.setDefaultValues(launcher, org.comu.homescreen.R.xml.settings, false);
		}
		mLauncher = launcher;
	}
