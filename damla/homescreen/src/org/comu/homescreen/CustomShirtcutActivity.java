...
import org.comu.homescreen.actions.RunActionActivity;
...
public class CustomShirtcutActivity extends Activity implements OnClickListener {
	private static final String ACTION_ADW_PICK_ICON="org.comu.homescreen.icons.ACTION_PICK_ICON";//launcher 2 değildi=launcher
