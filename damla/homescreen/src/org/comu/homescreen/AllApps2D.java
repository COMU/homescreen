...
public class AllApps2D
    ...
    public class AppsAdapter extends ArrayAdapter<IconItemInfo> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = mInflater.inflate(org.comu.homescreen.R.layout.application_boxed, parent, false);
            }
...
//        Log.d(TAG, "zooming " + ((zoom == 1.0) ? "open" : "closed"));
        ...
        if (isVisible()) {
            ...
            if (animate) {
                startAnimation(AnimationUtils.loadAnimation(getContext(), org.comu.homescreen.R.anim.all_apps_2d_fade_in));
            } else {
                onAnimationEnd();
            }
        } else {
            if (animate) {
                startAnimation(AnimationUtils.loadAnimation(getContext(), org.comu.homescreen.R.anim.all_apps_2d_fade_out));
            } else {
                onAnimationEnd();
            }
        }
